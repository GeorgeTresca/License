...
class MealPlannerEnv:
    ...
    def step(self, action):
        ...
        protein_bonus = max(0, (meal['macros']['protein'] - 25) * 2)
...
def train_rl_agent(env, episodes=300000, epsilon=0.05, alpha=0.05):
    q_table = {}
...
calorie_targets = range(1900, 2601, 100)

q_table_file = "../tables/q_table_high-protein5.pkl"
...
if not os.path.exists(q_table_file):
    ...
    for calorie_target in calorie_targets:
        ...
        q_table = train_rl_agent(env, episodes=400000)
